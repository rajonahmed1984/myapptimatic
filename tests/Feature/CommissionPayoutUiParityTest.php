...
class CommissionPayoutUiParityTest extends TestCase
{
    ...
    #[Test]
    public function commission_payout_index_is_inertia_when_legacy_flag_is_off(): void
    {
    ...
    #[Test]
    public function commission_payout_index_remains_inertia_when_legacy_flag_is_on(): void
    {
    ...
    #[Test]
    public function commission_payout_index_permission_guard_remains_forbidden_for_client_role_with_or_without_legacy_flag(): void
    {
