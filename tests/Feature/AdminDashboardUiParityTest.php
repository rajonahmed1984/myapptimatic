    ...
    public function admin_dashboard_renders_direct_inertia_component_with_expected_props(): void
    {
        ...
        $this->mock(DashboardMetricsService::class, function (MockInterface $mock): void {
            $mock->shouldReceive('getMetrics')->once()->andReturn([
                ...
                'automationMetrics' => [],
                'periodMetrics' => [
                    'today' => ['new_orders' => 0, 'active_orders' => 0, 'income' => 0, 'expense' => 0, 'hosting_income' => 0],
                    'month' => ['new_orders' => 0, 'active_orders' => 0, 'income' => 0, 'expense' => 0, 'hosting_income' => 0],
                    'year' => ['new_orders' => 0, 'active_orders' => 0, 'income' => 0, 'expense' => 0, 'hosting_income' => 0],
                ],
                'periodSeries' => [
                    'today' => ['labels' => [], 'new_orders' => [], 'active_orders' => [], 'income' => [], 'expense' => []],
                    'month' => ['labels' => [], 'new_orders' => [], 'active_orders' => [], 'income' => [], 'expense' => []],
                    'year' => ['labels' => [], 'new_orders' => [], 'active_orders' => [], 'income' => [], 'expense' => []],
                ],
                'incomeStatement' => [],
