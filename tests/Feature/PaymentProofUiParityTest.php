...
class PaymentProofUiParityTest extends TestCase
{
    ...
    #[Test]
    public function payment_proofs_index_is_inertia_when_legacy_flag_is_off(): void
    {
    ...
    #[Test]
    public function payment_proofs_index_remains_inertia_when_legacy_flag_is_on(): void
    {
    ...
    #[Test]
    public function payment_proofs_index_permission_guard_remains_forbidden_for_client_role_with_or_without_legacy_flag(): void
    {
