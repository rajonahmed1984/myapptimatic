...
@section('content')
    <div class="card p-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <a href="{{ route('employee.projects.index') }}" class="text-xs font-semibold text-slate-500 hover:text-teal-600">
                Projects
            </a>
        </div>
                    ...
                    @forelse($projects as $project)
                        ...
                        <tr class="align-top">
                            ...
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('employee.projects.chat', $project) }}" class="text-xs font-semibold text-teal-600 hover:text-teal-500">
                                    Open Chat
                                </a>
                            </td>
                        </tr>
