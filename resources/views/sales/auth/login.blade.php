...
@section('content')
    <section class="relative -m-8 overflow-hidden rounded-2xl bg-slate-900 px-8 py-10 text-white sm:px-10">
        ...
        <div class="relative z-10">
            ...
            <form class="mt-8 space-y-5" method="POST" action="{{ route('sales.login.attempt', [], false) }}">
                @csrf
                <div>
                ...
                <div class="flex items-center justify-between text-sm text-slate-200/85">
                    ...
                    <a href="{{ route('sales.password.request') }}" class="text-teal-300 hover:text-teal-200">Forgot password?</a>
                </div>
