        ...
        <div class="rounded-2xl border border-slate-200 bg-white/80 p-4">
            ...
            <div class="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                @forelse($salesReps as $rep)
                    ...
                    @endphp
                    <a href="{{ route('admin.commission-payouts.create', ['sales_rep_id' => $rep->id]) }}" class="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 hover:border-emerald-300 hover:shadow-sm transition">
            ...
            <div class="mt-3 overflow-x-auto">
                <table class="min-w-full text-sm text-left">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-3 py-3 text-slate-500">No payouts yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
