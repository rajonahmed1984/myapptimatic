                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-4 py-3">
                                <div class="font-semibold text-slate-900">
                                    @if($maintenance->project)
                                        <a href="{{ route('admin.projects.show', $maintenance->project) }}" class="text-teal-700 hover:text-teal-600">
                            ...
                            <td class="px-4 py-3">
                                @if($maintenance->customer)
                                    <a href="{{ route('admin.customers.show', $maintenance->customer) }}" class="text-teal-700 hover:text-teal-600">
