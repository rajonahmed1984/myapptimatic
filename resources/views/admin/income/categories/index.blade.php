        ...
        <div class="card p-6">
            ...
            <form method="POST" action="{{ $formAction }}" class="mt-4 grid gap-3 text-sm">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    @if($isEditing)
                        <a href="{{ route('admin.income.categories.index') }}" class="text-xs font-semibold text-slate-500 hover:text-slate-700">Cancel edit</a>
                    @endif
                </div>
            </form>
        </div>
                            ...
                            <tr class="border-b border-slate-100">
                                ...
                                <td class="py-2 px-3 text-right">
                                    <div class="flex justify-end gap-3 text-xs font-semibold">
                                        <a href="{{ route('admin.income.categories.index', ['edit' => $category->id]) }}" class="text-teal-600 hover:text-teal-500">Edit</a>
                                        <form
                                            method="POST"
