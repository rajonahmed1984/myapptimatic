                        ...
                        <tr class="border-b border-slate-100">
                            ...
                            <td class="py-2 px-3 text-right">
                                <div class="flex justify-end gap-3 text-xs font-semibold">
                                    <a href="{{ route('admin.expenses.categories.edit', $category) }}" class="text-teal-600 hover:text-teal-500">Edit</a>
                                    <form method="POST" action="{{ route('admin.expenses.categories.destroy', $category) }}">
                                        @csrf
                                        @method('DELETE')
