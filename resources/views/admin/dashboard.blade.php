...
@section('content')
    ...
    @php
        $projectMaintenance = $projectMaintenance ?? ['projects_active' => 0, 'projects_on_hold' => 0, 'subscriptions_blocked' => 0, 'renewals_30d' => 0];
        $hrStats = $hrStats ?? [
            'active_employees' => 0,
    ...
    <div class="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="card p-4">
            ...
            <div class="mt-1 text-xs text-slate-500">Finalized items pending payment</div>
        </div>
    </div>
