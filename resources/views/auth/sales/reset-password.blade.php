...
@section('title', 'Sales Reset Password')

@section('content')
    <div class="section-label">Sales portal</div>
    ...
    <form class="mt-8 space-y-5" method="POST" action="{{ route('sales.password.update') }}">
        @csrf
    ...
    <p class="mt-6 text-xs text-slate-500">
        Back to <a href="{{ $loginRoute ?? route('sales.login') }}" class="font-semibold text-teal-600 hover:text-teal-500">sign in</a>.
    </p>
@endsection
