        ...
        <>
            ...
            <div className="card p-5">
                <div className="mb-3 flex items-center justify-between">
                    <div className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Task Chat</div>
                ...
                {aiReady && routes?.aiSummary ? (
                    <div className="mt-4 text-xs text-slate-500">AI summary available.</div>
                ) : null}
            </div>
        </>
    );
