...
const CRITICAL_ROUTE_PATTERNS = [
    ...
    /(^|\/)client\/projects(\/|$)/i,
    /(^|\/)client\/affiliates(\/|$)/i,
    /(^|\/)employee\/(dashboard|tasks|chats|profile|work-logs|timesheets|leave-requests|attendance|payroll|projects)(\/|$)/i,
    /(^|\/)sales\/(dashboard|tasks|chats|profile|earnings|payouts|projects)(\/|$)/i,
    /(^|\/)support\/(dashboard|support-tickets)(\/|$)/i,
