                ...
                <div className="card p-6">
                    ...
                    <DataTable
                        ...
                        columns={[
                            ...
                            { key: 'total', header: 'Total expense', cellClassName: 'text-slate-700', render: (category) => category.total_expense_display || '0.00' },
                            {
                                key: 'status',
                                header: 'Status',
                        ...
                        renderMobileCard={(category) => (
                            <MobileCard
                                ...
                                metrics={[{ label: 'Total Expense', value: category.total_expense_display || '0.00' }]}
                                actions={
                                    <>
                                        <a
